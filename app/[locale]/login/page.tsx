...
export default async function Login({
  ...
  return (
    <>
      ...
      <div className="flex w-full flex-1 flex-col items-center gap-5 px-8 pt-32 pb-28 sm:max-w-md">
        <Link href="/">
          {" "}
          <svg
        ...
        >
          ...
          <input
            className="mb-3 rounded-md border text-gray-800 bg-background  px-4 py-2 text-[16px]"
            type="email"
            name="email"
          ...
          <input
            className="mb-6 rounded-md border text-gray-800 bg-background px-4 py-2 text-[16px]"
            type="password"
            name="password"
            placeholder="••••••••"
          />
          ...
          <SubmitButton
            formAction={signUp}
            className="mb-2 rounded-md border border-input bg-background text-white px-4 py-2"
          >
            Sign Up
          </SubmitButton>
