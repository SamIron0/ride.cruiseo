...
export default function UserMenu({ user }: Prop) {
    ...
    return (
        <>
            <div className={cn(
                "top-0 sticky py-3 px-12 z-20 w-full py-3 px-12 bg-gray-100 flex flex-row flex-nowrap justify-between mx-auto h-14 items-stretch animate-in fade-in slide-in-from-top-4 duration-1000 ease-in-out",
                BODY_PADDING
            )}>
                <Link
