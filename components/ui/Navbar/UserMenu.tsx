    ...
    return (
        <>
            <div className={cn(
                ...
                {isOpen ?
                    <div ref={menuRef} id="dropdownInformation" className="z-10 mt-14 mr-6 absolute top-0 right-0 bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600">
