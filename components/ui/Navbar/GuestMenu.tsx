        ...
        <>
            <div className={cn(
                ...
                <div className="flex flex-row flex-nowrap gap-x-1.5 items-center">
                    <div className="flex flex-row flex-nowrap hover:bg-gray-300 gap-x-1.5 items-center">
                        <a href="/signup" className="block py-2 px-3 text-gray-900 rounded md:border-0  md:p-0">Sign up</a>
                    </div>
                    <div className="flex flex-row flex-nowrap gap-x-1.5 items-center">
                        <Link href="/signin"
