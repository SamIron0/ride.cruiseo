        ...
        <>
            <div className={cn(
                ...
                <div className="flex flex-row flex-nowrap gap-x-1.5 items-center">
                    <a href="/signup" className="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-fuchsia-700 md:p-0">Sign up</a>
