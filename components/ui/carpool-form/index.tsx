      ...
      <div className="flex  flex-col  p-4 h-screen w-full ">
        <div className="sm:px-24 md:px-30 lg:px-52 ">
          ...
          <form onSubmit={handleTripDetailsSubmit} className=" h-fit flex flex-col px-1 justify-center items-center w-full">
            ...
            <div className="flex z-1 mb-4 flex-col items-center border-gray-300 border w-full p-6 lg:p-12 h-lg shadow-2xl rounded-3xl shadow-blue-gray-500/40">
            ...
            <div className="flex z-10 flex-col mb-4 border-gray-300  border w-full p-6 lg:p-12 h-lg shadow-2xl rounded-3xl shadow-blue-gray-500/40">
              <div className="w-full">
