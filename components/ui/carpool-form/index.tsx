      ...
      <div className="flex  flex-col  p-4 h-screen w-full ">
        <div className="sm:px-24 md:px-30 lg:px-52 ">
          ...
          <form onSubmit={handleTripDetailsSubmit} className=" h-fit flex flex-col px-1 justify-center items-center w-full">
            ...
            <div className="flex mb-4 flex-col items-center relative"> {/* Add relative positioning */}

              <div className="border-gray-300 border w-full p-6 lg:p-12 h-lg shadow-2xl rounded-3xl shadow-blue-gray-500/40">

                <div className="w-full">
                  <h1 className="font-mono font-semi-bold  text-black text-md mb-3">Where to?</h1>
            ...
            <div className="flex flex-col mb-4 border-gray-300 border w-full p-6 lg:p-12 h-lg shadow-2xl rounded-3xl shadow-blue-gray-500/40 relative z-10">
              <div className="w-full">
                <h1 className="font-mono font-semi-bold  text-black text-[25px] mb-3">From where?</h1>
            ...
            <div className="flex flex-col z-20 mb-4 border-gray-300  border w-full p-6 lg:p-12 h-lg shadow-2xl rounded-3xl shadow-blue-gray-500/40">
              <div className="w-full">
                <h1 className="font-mono font-semi-bold  text-black text-[25px] mb-3">When?</h1>
