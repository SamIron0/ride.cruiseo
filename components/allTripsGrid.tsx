    ...
    return (
        ...
        <Tabs initialValue="1" align={align} leftSpace={leftSpace}>
            ...
            <Tabs.Item
                ...
                <div className="animate-in fade-in md:px-24  px-8 sm:p-12  pt-4 slide-in-from-bottom-4 duration-1200 w-full ease-in-out">
            ...
            <Tabs.Item
                ...
                <div className="animate-in fade-in md:px-24 px-8 pt-4 sm:p-12 slide-in-from-bottom-4 duration-1200 w-full ease-in-out">
