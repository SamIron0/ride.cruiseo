        ...
        <Tabs initialValue="1" align="center"  onChange={handleTabChange} leftSpace={0}>
            <Tabs.Item label={<> <svg
                ...
                <div className="animate-in fade-in p-8 sm:p-12 slide-in-from-bottom-4 duration-1200 w-full ease-in-out">
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3  lg:grid-cols-4 xl:grid-cols-5 gap-6 justify-items-stretch w-full">
                        {allTrips?.map((trip) => (
                            <>
                                <TripCard trip={trip} /></>
                        ))}</div>
            ...
            <Tabs.Item
                className={`h-30 ${activeTab === '1' ? 'text-black' : 'text-gray-500'}`}
                label={<> <svg xmlns="http://www.w3.org/2000/svg" height="38" viewBox="0 -960 960 960" width="24"><path d="M120-120v-80h720v80H120Zm74-200L80-514l62-12 70 62 192-52-162-274 78-24 274 246 200-54q32-9 58 12t26 56q0 22-13.5 39T830-492L194-320Z" /></svg> Airport Trips </>} value="3">
                <div className="animate-in fade-in p-8 sm:p-12 slide-in-from-bottom-4 duration-1200 w-full ease-in-out">
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5  gap-6 justify-items-stretch w-full">
