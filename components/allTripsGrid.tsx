    ...
    return (
        ...
        <Tabs initialValue="1" align={align} leftSpace={leftSpace}>
            <Tabs.Item label={<> <svg
                ...
                value="1">
                <div className="animate-in fade-in md:px-24 sm:p-12 px-16 slide-in-from-bottom-4 duration-1200 w-full ease-in-out">
            ...
            <Tabs.Item
                ...
                <div className="animate-in fade-in md:px-24  px-16 sm:p-12  slide-in-from-bottom-4 duration-1200 w-full ease-in-out">
                    <div className="grid justify-center grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6 justify-items-stretch w-full">
            ...
            <Tabs.Item
                ...
                <div className="animate-in fade-in md:px-24 px-16 sm:p-12 sm:px-12 slide-in-from-bottom-4 duration-1200 w-full ease-in-out">
