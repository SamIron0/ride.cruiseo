...
export function HowFaresCalculated() {
    return (
        <div className="lg:flex p-6 sm:p-12 items-center w-full text-white bg-black">

            {/* First div */}
            <div className="lg:w-1/2 sm:w-full">
                <h1 className=" text-white pb-6 pt-6 font-medium text-3xl">How Fares Are Calculated</h1>
                <ul className="pl-2">
