...
export function HowFaresCalculated() {
    return (
        <div className="lg:flex p-8 sm:p-12  w-full text-white bg-black">
                ...
                <ul className="pl-2">
                    <span className="lg:max-w-md">
                        <li className="flex items-center pb-1">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-target"><circle cx="12" cy="12" r="10" /><circle cx="12" cy="12" r="6" /><circle cx="12" cy="12" r="2" />
                            </svg>
            ...
            <div className="lg:w-1/2  pt-8 sm:pt-0 sm:w-full">
